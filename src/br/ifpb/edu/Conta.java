...
/**
 * Esta classe abstrata permitira o polimorfismo para a cria��o de novos tipos de conta
...
public abstract class Conta {
	...
	public String getExtrato( ) {
		...
		if( cobranca <= saldo ) {
			saldo -= cobranca;
			setExtrato( "Cobranaça de: R$" + cobranca + ", pelo extrato."  );
			return extrato;
		}
		return null;
	}
	...
	/**
	 * Função chamada para adicionar informações sobre o extrato
	 */
	...
	/**
	 * Este metodo sobrescreve a função toString com informações sobre a conta
